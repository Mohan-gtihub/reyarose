...
class ItemRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        return [
            ...
            'length.required'           =>  __('Length field is required.'),
            'weight.required'           =>  __('Weight field is required.'),
            'height.required'           =>  __('Height field is required.'),
            'breadth.required'           =>  __('Breadth field is required.'),

...
class PromoCodeController extends Controller
{
    ...
    public function store(PromoCodeRequest $request)
    {
        ...
        $input = $request->all();
        $input['banner'] = ImageHelper::handleUploadedImage($request->file('banner'),'assets/images');
    ...
    public function update(PromoCodeRequest $request, PromoCode $code)
    {
        ...
        if ($file = $request->file('banner')) {
            $input['banner'] = ImageHelper::handleUpdatedUploadedImage($file,'/assets/images',$code,'/assets/images/','banner');
        }

    ...
    <td>
        <div class="dropdown">
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="{{ route('back.catalogue.status',[$data->id,1,'status']) }}">{{ __('Enable') }}</a>
              <a class="dropdown-item" href="{{ route('back.catalogue.status',[$data->id,0,'status']) }}">{{ __('Disable') }}</a>
            </div>
        </div>
    </td>
    {{-- <td>
    ...
    <td>
        <div class="action-list">
            <a class="btn btn-secondary btn-sm "
                href="{{ route('back.catalogue.edit',$data->id) }}">
                <i class="fas fa-edit"></i>
            </a>
            <a class="btn btn-danger btn-sm " data-toggle="modal"
                data-target="#confirm-delete" href="javascript:;"
                data-href="{{ route('back.catalogue.destroy',$data->id) }}">

                                    ...
                                    <div class="">
                                        ...
                                        <div id="basic" class="tab-pane active"><br>
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        <label for="top_nav_text">{{ __('Top Navbar Text') }} *</label>
                                                        <textarea name="top_nav_text" id="top_nav_text" class="form-control" rows="5"
                                                                placeholder="{{ __('Top Navbar text (Max 100 characters)') }}"
                                                                >{{ $setting->top_nav_text }}</textarea>
                                                    </div>
                                                </div>
